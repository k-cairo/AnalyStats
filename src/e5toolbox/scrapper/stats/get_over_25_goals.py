        ...
        if self.status.success:
            for iframe in self.OVER_25_GOALS_IFRAMES:
                ...
                for table_tr in table_trs:
                    ...
                    home_over_25_goals: int = 0
                    home_over_25_goals_percent: str = ""
                    away_team_name: str = ""
                    away_matches_played: int = 0
                    away_over_25_goals: int = 0
                    away_over_25_goals_percent: str = ""
                    overall_team_name: str = ""
                    overall_matches_played: int = 0
                    overall_over_25_goals: int = 0
                    overall_over_25_goals_percent: str = ""
                    try:
                    ...
                    if not home_over_25_goals_stats.exists():
                        ...
                        self.log_info(message=f"Parse Over 2.5 Goals Stats : {home_team.name} created")
                    else:
                        ...
                        self.log_info(message=f"Parse Over 2.5 Goals Stats : {home_team.name} updated")
                    ...
                    if not away_over_25_goals_stats.exists():
                        ...
                        self.log_info(message=f"Parse Over 2.5 Goals Stats : {away_team.name} created")
                    else:
                        ...
                        self.log_info(message=f"Parse Over 2.5 Goals Stats : {away_team.name} updated")
                    ...
                    if not overall_over_25_goals_stats.exists():
                        ...
                        self.log_info(message=f"Parse Over 2.5 Goals Stats : {overall_team.name} created")
                    else:
                        ...
                        self.log_info(message=f"Parse Over 2.5 Goals Stats : {overall_team.name} updated")
                ...
                for table_tr in table_trs:
                    ...
                    if not home_over_25_goals_stats.exists():
                        home_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 1H Stats : {home_team.name} created")
                    else:
                        target_home_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=home_team)
                        target_home_over_25_goals_stats.home_matches_played = home_matches_played
                        ...
                        target_home_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 1H Stats : {home_team.name} updated")
                    ...
                    if not away_over_25_goals_stats.exists():
                        away_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 1H Stats : {away_team.name} created")
                    else:
                        target_away_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=away_team)
                        target_away_over_25_goals_stats.away_matches_played = away_matches_played
                        ...
                        target_away_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 1H Stats : {away_team.name} updated")
                    ...
                    if not overall_over_25_goals_stats.exists():
                        overall_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 1H Stats : {overall_team.name} created")
                    else:
                        target_overall_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=overall_team)
                        target_overall_over_25_goals_stats.overall_matches_played = overall_matches_played
                        ...
                        target_overall_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 1H Stats : {overall_team.name} updated")
                ...
                for table_tr in table_trs:
                    ...
                    if not home_over_25_goals_stats.exists():
                        home_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 2H Stats : {home_team.name} created")
                    else:
                        target_home_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=home_team)
                        target_home_over_25_goals_stats.home_matches_played = home_matches_played
                        ...
                        target_home_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 2H Stats : {home_team.name} updated")
                    ...
                    if not away_over_25_goals_stats.exists():
                        away_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 2H Stats : {away_team.name} created")
                    else:
                        target_away_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=away_team)
                        target_away_over_25_goals_stats.away_matches_played = away_matches_played
                        ...
                        target_away_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 2H Stats : {away_team.name} updated")
                    ...
                    if not overall_over_25_goals_stats.exists():
                        overall_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 2H Stats : {overall_team.name} created")
                    else:
                        target_overall_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=overall_team)
                        target_overall_over_25_goals_stats.overall_matches_played = overall_matches_played
                        ...
                        target_overall_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals 2H Stats : {overall_team.name} updated")
                ...
                for table_tr in table_trs:
                    ...
                    if not home_over_25_goals_stats.exists():
                        home_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals BH Stats : {home_team.name} created")
                    else:
                        target_home_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=home_team)
                        target_home_over_25_goals_stats.home_matches_played = home_matches_played
                        ...
                        target_home_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals BH Stats : {home_team.name} updated")
                    ...
                    if not away_over_25_goals_stats.exists():
                        away_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals BH Stats : {away_team.name} created")
                    else:
                        target_away_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=away_team)
                        target_away_over_25_goals_stats.away_matches_played = away_matches_played
                        ...
                        target_away_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals BH Stats : {away_team.name} updated")
                    ...
                    if not overall_over_25_goals_stats.exists():
                        overall_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals BH Stats : {overall_team.name} created")
                    else:
                        target_overall_over_25_goals_stats: E5Over25GoalsStats = E5Over25GoalsStats.objects.get(
                            team=overall_team)
                        target_overall_over_25_goals_stats.overall_matches_played = overall_matches_played
                        ...
                        target_overall_over_25_goals_stats.save()
                        self.log_info(message=f"Parse Over 2.5 Goals BH Stats : {overall_team.name} updated")

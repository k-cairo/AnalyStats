            ...
            for iframe in self.EG_IFRAMES:
                ...
                for table_tr in table_trs:
                    ...
                    if not home_eg_stats.exists():
                        home_eg_stats.save()
                        self.log_info(f"Team {home_team.name} Early Goals Stats created in database")
                    else:
                        ...
                        home_eg_stats.home_scored_or_conceded_early = home_scored_or_conceded_early
                        home_eg_stats.save()
                        self.log_info(f"Team {home_team.name} Early Goals Stats updated in database")
                    ...
                    if not away_eg_stats.exists():
                        away_eg_stats.save()
                        self.log_info(f"Team {away_team.name} Early Goals Stats created in database")
                    else:
                        ...
                        away_eg_stats.away_scored_or_conceded_early = away_scored_or_conceded_early
                        away_eg_stats.save()
                        self.log_info(f"Team {away_team.name} Early Goals Stats updated in database")
                    ...
                    if not overall_eg_stats.exists():
                        ...
                        self.log_info(f"Team {overall_team.name} Early Goals Stats created in database")
                    else:
                        ...
                        overall_eg_stats.overall_scored_or_conceded_early = overall_scored_or_conceded_early
                        overall_eg_stats.save()
                        self.log_info(f"Team {overall_team.name} Early Goals Stats updated in database")

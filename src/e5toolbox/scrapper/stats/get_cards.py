...
class E5GetCards(E5SeleniumWebDriver):
    ...
    def get_iframes(self) -> None:
        self.process_get_iframe(endpoint="cards/", error_context=f"{self.ERROR_CONTEXT}.get_iframes()",
                                iframe_length=4, save_message="Cards Iframe created in database", class_=E5CardsIframes)
